...
var AlertContext = React2.createContext({
  color: "primary",
  variant: "solid",
  isPill: false,
  open: true,
...
function AlertRootBase({
  ...
  const [uncontrolledOpen, setUncontrolledOpen] = React2.useState(true);
  ...
  return open ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
      ...props,
      ref,
      ...
      "data-pill": isPill,
      className: styles,
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AlertContext.Provider, { value: contextValue, children })
    }
  ) : null;
}
AlertRootBase.displayName = "MaterialTailwind.Alert";
var AlertRoot = React2.forwardRef(AlertRootBase);
...
var AlertContent = React2.forwardRef(AlertContentRoot);
...
var AlertIcon = React2.forwardRef(AlertIconRoot);
function AlertDismissTriggerRoot({ as, ripple, className, children, ...props }, ref) {
  const Component = as ?? "button";
  const contextTheme = useTheme();
  const { setOpen } = React2.useContext(AlertContext);
  const theme2 = contextTheme?.alertDismissTrigger ?? alertDismissTriggerTheme;
  const styles = children ? className : (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  function closeAlert(event) {
    setOpen?.(false);
    props.onClick?.(event);
  }
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, ref, className: styles, onClick: closeAlert, children: children || /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      viewBox: "0 0 24 24",
      fill: "none",
...
var AlertDismissTrigger = React2.forwardRef(
