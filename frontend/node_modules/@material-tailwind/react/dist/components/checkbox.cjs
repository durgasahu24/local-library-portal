...
var CheckboxContext = React2.createContext({
  color: "primary",
  disabled: false,
  checked: false
});
function CheckboxRootBase({ color, disabled, className, children, ...props }, ref) {
  ...
  const [checked, setChecked] = React2.useState(props?.checked || false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "label",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CheckboxContext.Provider, { value: contextValue, children })
      ]
    }
  );
}
CheckboxRootBase.displayName = "MaterialTailwind.Checkbox";
var CheckboxRoot = React2.forwardRef(CheckboxRootBase);
function CheckboxIndicatorRoot({ as, className, children, ...props }, ref) {
  const Component = as || "span";
  const contextTheme = useTheme();
  const { checked } = React2.useContext(CheckboxContext);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, "data-checked": checked, className: styles, ref, children: children || /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      fill: "none",
      width: "18px",
...
var CheckboxIndicator = React2.forwardRef(CheckboxIndicatorRoot);
