...
var ChipContext = React2.createContext({
  size: "md",
  color: "primary",
  variant: "solid",
  open: true,
...
function ChipRootBase({
  ...
  return open ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
      ...
      className: styles,
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChipContext.Provider, { value: contextValue, children })
    }
  ) : null;
}
ChipRootBase.displayName = "MaterialTailwind.Chip";
var ChipRoot = React2.forwardRef(ChipRootBase);
function ChipLabelRoot({ as, className, children, ...props }, ref) {
  const Component = as ?? "span";
  const contextTheme = useTheme();
  const { size } = React2.useContext(ChipContext);
...
var ChipLabel = React2.forwardRef(ChipLabelRoot);
...
var ChipIcon = React2.forwardRef(ChipIconRoot);
function ChipDismissTriggerRoot({ as, ripple, className, children, ...props }, ref) {
  const Component = as ?? "button";
  const contextTheme = useTheme();
  const { size, color, variant, setOpen } = React2.useContext(ChipContext);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, ref, className: styles, onClick: handleClick, children: children || /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      viewBox: "0 0 24 24",
      fill: "none",
...
var ChipDismissTrigger = React2.forwardRef(ChipDismissTriggerRoot);
