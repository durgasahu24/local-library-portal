...
function CollapseRoot({ as, open, className, children, ...props }, ref) {
  ...
  return open ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, ref, "data-open": open, className: styles, children }) : null;
}
CollapseRoot.displayName = "MaterialTailwind.Collapse";
var Collapse = React2.forwardRef(CollapseRoot);
