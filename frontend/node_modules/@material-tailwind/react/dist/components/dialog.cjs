...
function DialogRoot({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DialogContext.Provider, { value: contextValue, children });
}
...
function DialogTriggerRoot({ as, className, children, ...props }, ref) {
  ...
  const { refs, getReferenceProps, open } = React2.useContext(DialogContext);
...
var DialogTrigger = React2.forwardRef(DialogTriggerRoot);
function DialogOverlayRoot({ className, lockScroll, children, ...props }, ref) {
  ...
  const defaultProps = theme2?.defaultProps;
  const { open } = React2.useContext(DialogContext);
...
var DialogOverlay = React2.forwardRef(DialogOverlayRoot);
function DialogContentRoot({
  ...
  const defaultProps = theme2.defaultProps;
  const { context, refs, getFloatingProps, open, size } = React2.useContext(DialogContext);
...
var DialogContent = React2.forwardRef(DialogContentRoot);
function DialogDismissTriggerRoot({ as, className, children, ...props }, ref) {
  ...
  const { open, setOpen } = React2.useContext(DialogContext);
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
...
var DialogDismissTrigger = React2.forwardRef(
