...
var DrawerContext = React2.createContext(
  {}
);
function DrawerRoot({
  open: controlledOpen,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DrawerContext.Provider, { value: contextValue, children });
}
...
function DrawerTriggerRoot({ as, className, children, ...props }, ref) {
  ...
  const { refs, getReferenceProps, open } = React2.useContext(DrawerContext);
...
var DrawerTrigger = React2.forwardRef(DrawerTriggerRoot);
function DrawerOverlayRoot({ className, lockScroll, children, ...props }, ref) {
  ...
  const { open } = React2.useContext(DrawerContext);
...
var DrawerOverlay = React2.forwardRef(DrawerOverlayRoot);
function DrawerPanelRoot({
  ...
  const defaultProps = theme2.defaultProps;
  const { context, refs, getFloatingProps, open } = React2.useContext(DrawerContext);
...
var DrawerPanel = React2.forwardRef(DrawerPanelRoot);
function DrawerDismissTriggerRoot({ as, className, children, ...props }, ref) {
  ...
  const { open, setOpen } = React2.useContext(DrawerContext);
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
...
var DrawerDismissTrigger = React2.forwardRef(
