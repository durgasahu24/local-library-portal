...
var InputContext = React2.createContext({
  size: "md",
  color: "primary",
  isError: false,
  isSuccess: false,
...
function InputRootBase({
  ...
  const [isIconDefined, setIsIconDefined] = React2.useState(false);
  const [iconPlacement, setIconPlacement] = React2.useState("start");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { className: "relative w-full", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InputContext.Provider, { value: contextValue, children: [
...
var InputRoot = React2.forwardRef(InputRootBase);
function InputIconRoot({ as, placement, ...props }, ref) {
  ...
  const {
    ...
    isSuccess,
    disabled
  } = React2.useContext(InputContext);
  ...
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, theme2.size[size], props?.className);
...
var InputIcon = React2.forwardRef(InputIconRoot);
