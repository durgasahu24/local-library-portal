...
type InputProps<T extends React.ElementType = "input"> = BaseProps<T, {
    isPill?: boolean;
    isError?: boolean;
    isSuccess?: boolean;
    disabled?: boolean;
} & Omit<SharedProps, "variant">>;
declare const InputRoot: <T extends React.ElementType<any, keyof React.JSX.IntrinsicElements> = "input">(props: {
...
declare const Input: (<T extends React.ElementType<any, keyof React.JSX.IntrinsicElements> = "input">(props: {
    isPill?: boolean | undefined;
    isError?: boolean | undefined;
    isSuccess?: boolean | undefined;
    disabled?: boolean | undefined;
    ...
    Icon: <T extends React.ElementType<any, keyof React.JSX.IntrinsicElements> = "span">(props: {
        placement?: "start" | "end" | undefined;
    } & {
        as?: T | undefined;
    } & Omit<React.PropsWithoutRef<React.ComponentProps<T>>, "as" | "placement"> & {
...
export { Input, InputContext, InputContextProps, InputIcon, InputIconProps, InputProps, InputRoot, Input as default };
