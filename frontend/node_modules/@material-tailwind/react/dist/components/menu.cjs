...
var MenuContext = React2.createContext({
  open: false,
  setOpen: () => {
  }
});
function MenuCore({
  ...
  const tree = (0, import_react2.useFloatingTree)();
  const nodeId = (0, import_react2.useFloatingNodeId)();
  const parentId = (0, import_react2.useFloatingParentNodeId)();
  const item = (0, import_react2.useListItem)();
  ...
  const { floatingStyles, refs, context } = (0, import_react2.useFloating)({
    nodeId,
    placement,
    open,
    onOpenChange: setOpen,
    whileElementsMounted: import_react3.autoUpdate,
    middleware: [(0, import_react3.offset)(offset), (0, import_react3.flip)(), (0, import_react3.shift)({ padding: 5 })]
  });
  const hover = (0, import_react2.useHover)(context, {
    enabled: isNested,
    delay: { open: 75 },
    handleClose: (0, import_react3.safePolygon)({ blockPointerEvents: true })
  });
  ...
  const role = (0, import_react2.useRole)(context, { role: "menu" });
  const dismiss = (0, import_react2.useDismiss)(context, { bubbles: true });
  const listNavigation = (0, import_react2.useListNavigation)(context, {
    listRef: elementsRef,
    activeIndex,
    nested: isNested,
    onNavigate: setActiveIndex
  });
  const { getReferenceProps, getFloatingProps, getItemProps } = (0, import_react2.useInteractions)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react.FloatingNode, { id: nodeId, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(MenuContext.Provider, { value: contextValue, children }) });
}
function MenuRoot(props) {
  const parentId = (0, import_react2.useFloatingParentNodeId)();
  return parentId === null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react.FloatingTree, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(MenuCore, { ...props }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(MenuCore, { ...props });
}
...
function MenuTriggerRoot({ as, className, children, ...props }, ref) {
  ...
  const {
    ...
    getItemProps,
    open
  } = React2.useContext(MenuContext);
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  const elementRef = (0, import_react2.useMergeRefs)([refs?.setReference, item?.ref, ref]);
...
var MenuTrigger = React2.forwardRef(MenuTriggerRoot);
function MenuContentRoot({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react.FloatingList, { elementsRef, labelsRef, children: open && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react.FloatingPortal, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
...
var MenuContent = React2.forwardRef(MenuContentRoot);
function MenuItemRoot({
  ...
  const defaultProps = theme2.defaultProps;
  const { activeIndex, getItemProps } = React2.useContext(MenuContext);
  ...
  const elementRef = (0, import_react2.useMergeRefs)([item.ref, ref]);
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
...
var MenuItem = React2.forwardRef(MenuItemRoot);
