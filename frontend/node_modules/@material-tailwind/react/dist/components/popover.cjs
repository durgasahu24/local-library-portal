...
function PopoverRoot({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(PopoverContext.Provider, { value: contextValue, children });
}
...
function PopoverTriggerRoot({ as, className, children, ...props }, ref) {
  ...
  const { refs, getReferenceProps, open } = React2.useContext(PopoverContext);
...
var PopoverTrigger = React2.forwardRef(PopoverTriggerRoot);
function PopoverContentRoot({
  ...
  const defaultProps = theme2.defaultProps;
  const { context, refs, getFloatingProps, open, floatingStyles } = React2.useContext(PopoverContext);
...
var PopoverContent = React2.forwardRef(PopoverContentRoot);
function PopoverArrowRoot({ as, className, ...props }, ref) {
  ...
  const { placement, arrowRef, middlewareData } = React2.useContext(PopoverContext);
...
var PopoverArrow = React2.forwardRef(PopoverArrowRoot);
