...
var ProgressContext = React2.createContext({
  value: 0,
  color: "primary"
});
function ProgressRootBase({ as, size, color, value, className, children, ...props }, ref) {
  ...
  const contextValue = React2.useMemo(() => ({ value, color }), [value, color]);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ProgressContext.Provider, { value: contextValue, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, ref, className: styles, children }) });
}
ProgressRootBase.displayName = "MaterialTailwind.Progress";
var ProgressRoot = React2.forwardRef(ProgressRootBase);
function ProgressBarRoot({ as, className, children, ...props }, ref) {
  const Component = as ?? "div";
  const contextTheme = useTheme();
  const { color, value } = React2.useContext(ProgressContext);
...
var ProgressBar = React2.forwardRef(ProgressBarRoot);
