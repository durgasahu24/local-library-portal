...
var RadioContext = React2.createContext({
  globalValue: "",
  color: "primary",
  setGlobalValue: () => {
  }
...
function RadioRootBase({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(RadioContext.Provider, { value: contextValue, children })
    }
  );
}
RadioRootBase.displayName = "MaterialTailwind.Radio";
var RadioRoot = React2.forwardRef(RadioRootBase);
function RadioItemRoot({ disabled, className, children, value, ...props }, ref) {
  const contextTheme = useTheme();
  const theme2 = contextTheme?.radioItem ?? radioItemTheme;
  const { globalValue, setGlobalValue, color } = React2.useContext(RadioContext);
  const innerId = React2.useId();
  const innerValue = React2.useId();
...
var RadioItem = React2.forwardRef(RadioItemRoot);
function RadioIndicatorRoot({ as, className, children, ...props }, ref) {
  ...
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, className: styles, ref, children: children || /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      width: "10px",
      height: "10px",
...
var RadioIndicator = React2.forwardRef(RadioIndicatorRoot);
