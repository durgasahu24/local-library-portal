...
function RatingRoot({
  ...
  ratedIcon ??= defaultProps?.ratedIcon ?? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
  ...
  unratedIcon ??= defaultProps?.unratedIcon ?? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      xmlns: "http://www.w3.org/2000/svg",
      fill: "none",
  ...
  const [ratingValue, setRatingValue] = React2.useState(() => [
    ...Array(value).fill("rated"),
    ...Array(count - value).fill("un_rated")
  ]);
  const [ratingOnHover, setRatingOnHover] = React2.useState(() => [
    ...Array(count).fill("un_rated")
  ]);
  const [isHover, setIsHover] = React2.useState(false);
  const baseStyles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, theme2.color[color], className);
  const iconStyle = (0, import_tailwind_merge2.twMerge)(theme2.icon);
  const renderRating = (data) => data.map((el, idx) => {
    const isRated = el === "rated";
    const elementToRender = isRated ? ratedIcon : unratedIcon;
    return React2.isValidElement(elementToRender) ? React2.cloneElement(elementToRender, {
    ...
    }) : React2.createElement(elementToRender, {
      key: idx,
      onClick: () => {
        if (readonly)
          return;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, ref, className: baseStyles, children: isHover ? renderRating(ratingOnHover) : renderRating(ratingValue) });
}
RatingRoot.displayName = "MaterialTailwind.Rating";
var Rating = React2.forwardRef(RatingRoot);
