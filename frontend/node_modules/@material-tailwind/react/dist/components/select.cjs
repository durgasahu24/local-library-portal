...
var SelectContext = React2.createContext({
  size: "md",
  color: "primary",
  isError: false,
  isSuccess: false,
...
function SelectRootBase({
  ...
  const [selectedIndex, setSelectedIndex] = React2.useState(null);
  ...
  const handleSelect = React2.useCallback((index) => {
  ...
  const listNav = (0, import_react2.useListNavigation)(context, {
    listRef: elementsRef,
    activeIndex,
    selectedIndex,
    onNavigate: setActiveIndex
  });
  const labelsRefTypehead = React2.useRef(
    labelsRef.current.map((item) => item?.value)
  );
  const typeahead = (0, import_react2.useTypeahead)(context, {
  ...
  const role = (0, import_react2.useRole)(context, { role: "listbox" });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(SelectContext.Provider, { value: contextValue, children: [
    children,
...
var SelectRoot = React2.forwardRef(SelectRootBase);
function SelectTriggerRoot({
  ...
  const {
    ...
    isSuccess,
    disabled
  } = React2.useContext(SelectContext);
  const value = selected?.value;
  const element = selected?.element;
  const elementRef = (0, import_react2.useMergeRefs)([refs?.setReference, ref]);
  indicator ??= defaultProps?.indicator ?? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "svg",
    {
      viewBox: "0 0 24 24",
      fill: "none",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    Component,
    {
      ...
      children: [
        children ? children({ value, element }) : element ?? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { "data-slot": "placeholder", className: theme2.placeholder, children: placeholder }),
        indicator
      ]
    }
  );
...
var SelectTrigger = React2.forwardRef(SelectTriggerRoot);
function SelectListRoot({
  ...
  return isOpen ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
...
var SelectList = React2.forwardRef(SelectListRoot);
function SelectOptionRoot({
  ...
  const defaultProps = theme2?.defaultProps;
  const { getItemProps, handleSelect, activeIndex, selectedIndex, selected } = React2.useContext(SelectContext);
  ripple ??= defaultProps?.ripple ?? true;
  indicator ??= defaultProps?.indicator ?? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    "svg",
    {
      xmlns: "http://www.w3.org/2000/svg",
      fill: "none",
  ...
  const { ref: itemRef, index } = (0, import_react2.useListItem)({
  ...
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  const elementRef = (0, import_react2.useMergeRefs)([itemRef, ref]);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    Component,
    {
      ...props,
...
var SelectOption = React2.forwardRef(SelectOptionRoot);
