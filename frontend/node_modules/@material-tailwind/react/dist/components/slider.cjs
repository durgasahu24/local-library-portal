...
var SliderContext = React2.createContext({
  min: 0,
  max: 100,
  step: 1
});
function SliderRootBase({
  ...
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, theme2["size"][size], className);
  const elementRef = (0, import_react.useMergeRefs)([sliderRef, ref]);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SliderContext.Provider, { value: contextValue, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ref: elementRef, ...props, className: styles, children }) });
}
SliderRootBase.displayName = "MaterialTailwind.Slider";
var SliderRoot = React2.forwardRef(SliderRootBase);
function SliderRangeRoot({ as, className, children, ...props }, ref) {
  const Component = as || "div";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.sliderRange ?? sliderRangeTheme;
  const { sliderRef, value, onValueChange, min, max, step, color } = React2.useContext(SliderContext);
  ...
  return sliderInstance.getSteps().map(({ left, width }, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
      ref,
      ...props,
...
var SliderRange = React2.forwardRef(SliderRangeRoot);
function SliderThumbRoot({ as, className, children, ...props }, ref) {
  const Component = as || "button";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.sliderThumb ?? sliderThumbTheme;
  const { sliderRef, value, onValueChange, min, max, step, size, color } = React2.useContext(SliderContext);
  const sliderInstance = (0, import_react_ranger.useRanger)({
    getRangerElement: () => sliderRef.current,
    values: value,
    min: min ?? 0,
...
var SliderThumb = React2.forwardRef(SliderThumbRoot);
function SliderTickRoot({ as, className, children, ...props }, ref) {
  ...
  return sliderInstance.getTicks().map(({ value: value2, key, percentage }) => /* @__PURE__ */ (0, import_react2.createElement)(
    Component,
    {
      ...props,
      key,
...
var SliderTick = React2.forwardRef(SliderTickRoot);
