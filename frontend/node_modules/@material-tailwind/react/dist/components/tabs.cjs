...
var TabsContext = React2.createContext({
  activeTab: "",
  orientation: "horizontal"
});
function TabsRootBase({
  ...
  const [indicatorRect, setIndicatorRect] = React2.useState({
    clientWidth: 0,
    clientHeight: 0,
    offsetLeft: 0,
    offsetTop: 0
  });
  const [uncontrolledActiveTab, setUncontrolledActiveTab] = React2.useState(() => tabsValue);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TabsContext.Provider, { value: contextValue, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
      ...props,
      ref,
...
var TabsRoot = React2.forwardRef(TabsRootBase);
...
var TabsList = React2.forwardRef(TabsListRoot);
function TabsTriggerRoot({ as, value, className, children, ...props }, ref) {
  const Component = as || "button";
  const innerRef = React2.useRef(null);
  const [elementRect, setElementRect] = React2.useState(
    null
  );
  const contextTheme = useTheme();
  const theme2 = contextTheme.tabsTrigger || tabsTriggerTheme;
  const { activeTab, setActiveTab, setIndicatorRect } = React2.useContext(TabsContext);
  const isActive = activeTab === value;
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  const elementRef = (0, import_react.useMergeRefs)([innerRef, ref]);
  React2.useEffect(() => {
  ...
  const handleIndicatorRect = React2.useCallback(() => {
...
var TabsTrigger = React2.forwardRef(TabsTriggerRoot);
function TabsPanelRoot({ as, value, className, children, ...props }, ref) {
  const Component = as || "div";
  const contextTheme = useTheme();
  const theme2 = contextTheme.tabsPanel || tabsPanelTheme;
  const { activeTab, orientation } = React2.useContext(TabsContext);
  const isActive = activeTab === value;
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return isActive ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
      ...props,
      ref,
...
var TabsPanel = React2.forwardRef(TabsPanelRoot);
function TabsTriggerIndicatorRoot({ as, className, ...props }, ref) {
  ...
  const { indicatorRect } = React2.useContext(TabsContext);
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
...
var TabsTriggerIndicator = React2.forwardRef(
