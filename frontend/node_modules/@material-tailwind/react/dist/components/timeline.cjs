...
var TimelineContext = React2.createContext({
  value: "",
  setValue: () => {
  },
  color: "primary",
...
function TimelineRootBase({
  ...
  const [innerValue, setInnerValue] = React2.useState(defaultValue || "");
  value ??= innerValue;
  ...
  const mergedRef = (0, import_react.useMergeRefs)([ref, innerRef]);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TimelineContext.Provider, { value: contextValue, children })
    }
  );
}
TimelineRootBase.displayName = "MaterialTailwind.Timeline";
var TimelineRoot = React2.forwardRef(TimelineRootBase);
function TimelineItemRoot({ as, value, className, disabled, children, ...props }, ref) {
  ...
  const {
    ...
    orientation,
    value: contextValue
  } = React2.useContext(TimelineContext);
  const innerRef = React2.useRef(null);
  value ??= React2.useId();
...
var TimelineItem = React2.forwardRef(TimelineItemRoot);
function TimelineHeaderRoot({ as, className, children, ...props }, ref) {
  const Component = as || "div";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.timelineHeader ?? timelineHeaderTheme;
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, ref, className: styles, children });
}
TimelineHeaderRoot.displayName = "MaterialTailwind.TimelineHeader";
var TimelineHeader = React2.forwardRef(TimelineHeaderRoot);
function TimelineIconRoot({ as, className, children, ...props }, ref) {
  const Component = as || "span";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.timelineIcon ?? timelineIconTheme;
  const { color } = React2.useContext(TimelineContext);
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, theme2.color[color], className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, ref, className: styles, children });
}
TimelineIconRoot.displayName = "MaterialTailwind.TimelineIcon";
var TimelineIcon = React2.forwardRef(TimelineIconRoot);
function TimelineSeparatorRoot({ as, className, children, ...props }, ref) {
  ...
  const { orientation, color } = React2.useContext(TimelineContext);
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, theme2.color[color], className);
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
...
var TimelineBody = React2.forwardRef(TimelineBodyRoot);
