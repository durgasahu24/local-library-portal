...
var TooltipContext = React2.createContext({
  open: false,
  setOpen: () => {
  }
});
function TooltipRoot({
  ...
  const data = (0, import_react2.useFloating)({
    ...
    middleware: [
      ...
      (0, import_react3.shift)({ padding: 5 }),
      (0, import_react3.arrow)({
        element: arrowRef,
        padding: 5
      })
    ]
  ...
  const hover = (0, import_react2.useHover)(context, {
    ...
    handleClose: interactive ? (0, import_react3.safePolygon)() : null
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TooltipContext.Provider, { value: contextValue, children });
}
...
function TooltipTriggerRoot({ as, className, children, ...props }, ref) {
  ...
  const { refs, getReferenceProps, open } = React2.useContext(TooltipContext);
...
var TooltipTrigger = React2.forwardRef(TooltipTriggerRoot);
function TooltipContentRoot({ as, className, children, ...props }, ref) {
  ...
  const { refs, getFloatingProps, open, floatingStyles } = React2.useContext(TooltipContext);
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  const elementRef = (0, import_react2.useMergeRefs)([refs?.setFloating, ref]);
  return open ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react.FloatingPortal, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Component,
    {
      ...props,
      ref: elementRef,
...
var TooltipContent = React2.forwardRef(TooltipContentRoot);
function TooltipArrowRoot({ as, className, ...props }, ref) {
  ...
  const { placement, arrowRef, middlewareData } = React2.useContext(TooltipContext);
  const elementRef = (0, import_react2.useMergeRefs)([arrowRef, innerRef, ref]);
  const staticSide = {
    top: "bottom",
    right: "left",
    bottom: "top",
...
var TooltipArrow = React2.forwardRef(TooltipArrowRoot);
