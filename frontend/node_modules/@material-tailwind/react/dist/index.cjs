...
var require_plugin = __commonJS({
  "../../node_modules/.pnpm/tailwindcss@3.4.13/node_modules/tailwindcss/plugin.js"(exports, module2) {
    "use strict";
...
var require_tailwindcss_animate = __commonJS({
  "../../node_modules/.pnpm/tailwindcss-animate@1.0.7_tailwindcss@3.4.13/node_modules/tailwindcss-animate/index.js"(exports, module2) {
    "use strict";
...
__export(src_exports, {
  ...
  accordionContentTheme: () => accordionContentTheme,
  accordionItemTheme: () => accordionItemTheme,
  accordionTheme: () => accordionTheme,
  accordionTriggerTheme: () => accordionTriggerTheme,
  alertContentTheme: () => alertContentTheme,
  alertDismissTriggerTheme: () => alertDismissTriggerTheme,
  alertIconTheme: () => alertIconTheme,
  alertTheme: () => alertTheme,
  avatarTheme: () => avatarTheme,
  badgeContentTheme: () => badgeContentTheme,
  badgeIndicatorTheme: () => badgeIndicatorTheme,
  badgeTheme: () => badgeTheme,
  breadcrumbLinkTheme: () => breadcrumbLinkTheme,
  breadcrumbSeparatorTheme: () => breadcrumbSeparatorTheme,
  breadcrumbTheme: () => breadcrumbTheme,
  buttonGroupTheme: () => buttonGroupTheme,
  buttonTheme: () => buttonTheme,
  cardBodyTheme: () => cardBodyTheme,
  cardFooterTheme: () => cardFooterTheme,
  cardHeaderTheme: () => cardHeaderTheme,
  cardTheme: () => cardTheme,
  checkboxIndicatorTheme: () => checkboxIndicatorTheme,
  checkboxTheme: () => checkboxTheme,
  chipDismissTriggerTheme: () => chipDismissTriggerTheme,
  chipIconTheme: () => chipIconTheme,
  chipLabelTheme: () => chipLabelTheme,
  chipTheme: () => chipTheme,
  collapseTheme: () => collapseTheme,
  dialogContentTheme: () => dialogContentTheme,
  dialogDismissTriggerTheme: () => dialogDismissTriggerTheme,
  dialogOverlayTheme: () => dialogOverlayTheme,
  dialogTheme: () => dialogTheme,
  dialogTriggerTheme: () => dialogTriggerTheme,
  drawerDismissTriggerTheme: () => drawerDismissTriggerTheme,
  drawerOverlayTheme: () => drawerOverlayTheme,
  drawerPanelTheme: () => drawerPanelTheme,
  drawerTriggerTheme: () => drawerTriggerTheme,
  iconButtonTheme: () => iconButtonTheme,
  inputIconTheme: () => inputIconTheme,
  inputTheme: () => inputTheme,
  listItemEndTheme: () => listItemEndTheme,
  listItemStartTheme: () => listItemStartTheme,
  listItemTheme: () => listItemTheme,
  listTheme: () => listTheme,
  menuContentTheme: () => menuContentTheme,
  menuItemTheme: () => menuItemTheme,
  menuTheme: () => menuTheme,
  menuTriggerTheme: () => menuTriggerTheme,
  mergeTheme: () => mergeTheme,
  mtConfig: () => mtConfig,
  navbarTheme: () => navbarTheme,
  parseObject: () => parseObject,
  popoverArrowTheme: () => popoverArrowTheme,
  popoverContentTheme: () => popoverContentTheme,
  popoverTheme: () => popoverTheme,
  popoverTriggerTheme: () => popoverTriggerTheme,
  progressBarTheme: () => progressBarTheme,
  progressTheme: () => progressTheme,
  radioIndicatorTheme: () => radioIndicatorTheme,
  radioItemTheme: () => radioItemTheme,
  radioTheme: () => radioTheme,
  ratingTheme: () => ratingTheme,
  selectListTheme: () => selectListTheme,
  selectOptionTheme: () => selectOptionTheme,
  selectTheme: () => selectTheme,
  selectTriggerTheme: () => selectTriggerTheme,
  sliderRangeTheme: () => sliderRangeTheme,
  sliderTheme: () => sliderTheme,
  sliderThumbTheme: () => sliderThumbTheme,
  sliderTickTheme: () => sliderTickTheme,
  spinnerTheme: () => spinnerTheme,
  switchTheme: () => switchTheme,
  tabsListTheme: () => tabsListTheme,
  tabsPanelTheme: () => tabsPanelTheme,
  tabsTheme: () => tabsTheme,
  tabsTriggerIndicatorTheme: () => tabsTriggerIndicatorTheme,
  tabsTriggerTheme: () => tabsTriggerTheme,
  ...
  tooltipArrowTheme: () => tooltipArrowTheme,
  tooltipContentTheme: () => tooltipContentTheme,
  tooltipTheme: () => tooltipTheme,
  tooltipTriggerTheme: () => tooltipTriggerTheme,
...
var import_hex_rgb = __toESM(require("hex-rgb"), 1);
...
function getRgbChannels(hex) {
  const { red, green, blue } = (0, import_hex_rgb.default)(hex);
...
function ThemeProvider({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(MaterialTailwindThemeContext.Provider, { value: mergedTheme, children });
}
function useTheme() {
...
var AccordionItem = React2.forwardRef(AccordionItemRoot);
...
var AccordionTrigger = React2.forwardRef(AccordionTriggerRoot);
function AccordionContentRoot({ as, className, children, ...props }, ref) {
  ...
  const isOpen = isMultiple ? activeItem?.includes(value) : activeItem === value;
  const styles = (0, import_tailwind_merge2.twMerge)(theme2.baseStyle, className);
  return isOpen ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...props, ref, className: styles, "data-open": isOpen, children }) : null;
}
AccordionContentRoot.displayName = "MaterialTailwind.AccordionContent";
var AccordionContent = React2.forwardRef(AccordionContentRoot);
...
var AlertRoot = React3.forwardRef(AlertRootBase);
function AlertContentRoot({ as, className, children, ...props }, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Component, { ...props, ref, className: styles, children });
}
AlertContentRoot.displayName = "MaterialTailwind.AlertContent";
var AlertContent = React3.forwardRef(AlertContentRoot);
...
var AlertIcon = React3.forwardRef(AlertIconRoot);
function AlertDismissTriggerRoot({ as, ripple, className, children, ...props }, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Component, { ...props, ref, className: styles, onClick: closeAlert, children: children || /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
    "svg",
    {
      viewBox: "0 0 24 24",
      fill: "none",
...
var AlertDismissTrigger = React3.forwardRef(
...
var Avatar = React4.forwardRef(AvatarRoot);
...
function BreadcrumbRootBase({ as, className, children, ...props }, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Component, { ...props, ref, className: styles, children });
}
BreadcrumbRootBase.displayName = "MaterialTailwind.Breadcrumb";
var BreadcrumbRoot = React5.forwardRef(BreadcrumbRootBase);
...
var BreadcrumbLink = React5.forwardRef(BreadcrumbLinkRoot);
function BreadcrumbSeparatorRoot({ as, className, children, ...props }, ref) {
  ...
  const styles = (0, import_tailwind_merge5.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Component, { ...props, ref, className: styles, children: children || "/" });
}
BreadcrumbSeparatorRoot.displayName = "MaterialTailwind.BreadcrumbSeparator";
var BreadcrumbSeparator = React5.forwardRef(
...
var Button = React6.forwardRef(ButtonRoot);
...
var ButtonGroup = React7.forwardRef(ButtonGroupRoot);
...
var CheckboxRoot = React8.forwardRef(CheckboxRootBase);
function CheckboxIndicatorRoot({ as, className, children, ...props }, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Component, { ...props, "data-checked": checked, className: styles, ref, children: children || /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
    "svg",
    {
      fill: "none",
      width: "18px",
...
var CheckboxIndicator = React8.forwardRef(CheckboxIndicatorRoot);
...
function CardRootBase({ as, color, variant, className, children, ...props }, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Component, { ...props, ref, className: styles, children });
}
CardRootBase.displayName = "MaterialTailwind.Card";
var CardRoot = React9.forwardRef(CardRootBase);
...
var CardHeader = React9.forwardRef(CardHeaderRoot);
...
var CardBody = React9.forwardRef(CardBodyRoot);
...
var CardFooter = React9.forwardRef(CardFooterRoot);
...
function ChipRootBase({
  ...
  return open ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    Component,
    {
      ...props,
      ref,
      ...
      "data-shape": isPill ? "pill" : "default",
      className: styles,
      children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ChipContext.Provider, { value: contextValue, children })
    }
  ) : null;
}
ChipRootBase.displayName = "MaterialTailwind.Chip";
var ChipRoot = React10.forwardRef(ChipRootBase);
function ChipLabelRoot({ as, className, children, ...props }, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Component, { ...props, ref, className: styles, children });
}
ChipLabelRoot.displayName = "MaterialTailwind.ChipLabel";
var ChipLabel = React10.forwardRef(ChipLabelRoot);
...
var ChipIcon = React10.forwardRef(ChipIconRoot);
function ChipDismissTriggerRoot({ as, ripple, className, children, ...props }, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Component, { ...props, ref, className: styles, onClick: handleClick, children: children || /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
    "svg",
    {
      viewBox: "0 0 24 24",
      fill: "none",
...
var ChipDismissTrigger = React10.forwardRef(ChipDismissTriggerRoot);
...
function CollapseRoot({ as, open, className, children, ...props }, ref) {
  ...
  return open ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Component, { ...props, ref, "data-open": open, className: styles, children }) : null;
}
CollapseRoot.displayName = "MaterialTailwind.Collapse";
var Collapse = React11.forwardRef(CollapseRoot);
...
var DialogTrigger = React12.forwardRef(DialogTriggerRoot);
...
var DialogOverlay = React12.forwardRef(DialogOverlayRoot);
...
var DialogContent = React12.forwardRef(DialogContentRoot);
...
var DialogDismissTrigger = React12.forwardRef(
...
var DrawerTrigger = React13.forwardRef(DrawerTriggerRoot);
...
var DrawerOverlay = React13.forwardRef(DrawerOverlayRoot);
...
var DrawerPanel = React13.forwardRef(DrawerPanelRoot);
...
var DrawerDismissTrigger = React13.forwardRef(
...
var IconButton = React14.forwardRef(IconButtonRoot);
...
function InputRootBase({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(Component, { className: "relative w-full", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(InputContext.Provider, { value: contextValue, children: [
...
function InputIconRoot({ as, placement, ...props }, ref) {
  ...
  const styles = (0, import_tailwind_merge15.twMerge)(theme2.baseStyle, theme2.size[size], props?.className);
...
function ListRootBase({ as, className, children, ...props }, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(Component, { ...props, ref, className: styles, children });
}
...
function MenuContentRoot({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_react5.FloatingList, { elementsRef, labelsRef, children: open && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(import_react5.FloatingPortal, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
...
var PopoverTrigger = React18.forwardRef(PopoverTriggerRoot);
...
var PopoverContent = React18.forwardRef(PopoverContentRoot);
...
var PopoverArrow = React18.forwardRef(PopoverArrowRoot);
...
function ProgressRootBase({ as, size, color, value, className, children, ...props }, ref) {
  ...
  const contextValue = React19.useMemo(() => ({ value, color }), [value, color]);
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(ProgressContext.Provider, { value: contextValue, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(Component, { ...props, ref, className: styles, children }) });
}
ProgressRootBase.displayName = "MaterialTailwind.Progress";
var ProgressRoot = React19.forwardRef(ProgressRootBase);
...
var ProgressBar = React19.forwardRef(ProgressBarRoot);
...
var RadioRoot = React20.forwardRef(RadioRootBase);
...
var RadioItem = React20.forwardRef(RadioItemRoot);
function RadioIndicatorRoot({ as, className, children, ...props }, ref) {
  const Component = as || "span";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.radioIndicator ?? radioIndicatorTheme;
  const styles = (0, import_tailwind_merge20.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(Component, { ...props, className: styles, ref, children: children || /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
    "svg",
    {
      width: "10px",
      height: "10px",
...
var RadioIndicator = React20.forwardRef(RadioIndicatorRoot);
...
function RatingRoot({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(Component, { ...props, ref, className: baseStyles, children: isHover ? renderRating(ratingOnHover) : renderRating(ratingValue) });
}
RatingRoot.displayName = "MaterialTailwind.Rating";
var Rating = React21.forwardRef(RatingRoot);
...
var SelectRoot = React22.forwardRef(SelectRootBase);
...
var SelectTrigger = React22.forwardRef(SelectTriggerRoot);
...
var SelectList = React22.forwardRef(SelectListRoot);
...
var SelectOption = React22.forwardRef(SelectOptionRoot);
...
var Spinner = React23.forwardRef(SpinnerRoot);
...
var Switch = React24.forwardRef(SwitchRoot);
...
var TabsRoot = React25.forwardRef(TabsRootBase);
...
var TabsList = React25.forwardRef(TabsListRoot);
...
var TabsTrigger = React25.forwardRef(TabsTriggerRoot);
...
var TabsPanel = React25.forwardRef(TabsPanelRoot);
...
var TabsTriggerIndicator = React25.forwardRef(
...
var Textarea = React26.forwardRef(TextareaRoot);
...
var TooltipTrigger = React27.forwardRef(TooltipTriggerRoot);
...
var TooltipContent = React27.forwardRef(TooltipContentRoot);
...
var TooltipArrow = React27.forwardRef(TooltipArrowRoot);
...
function TypographyRoot({ as, color, type, className, children, ...props }, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(Component, { ...props, ref, className: styles, children });
}
TypographyRoot.displayName = "MaterialTailwind.Typography";
var Typography = React28.forwardRef(TypographyRoot);
...
var TimelineRoot = React29.forwardRef(TimelineRootBase);
...
var TimelineItem = React29.forwardRef(TimelineItemRoot);
function TimelineHeaderRoot({ as, className, children, ...props }, ref) {
  const Component = as || "div";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.timelineHeader ?? timelineHeaderTheme;
  const styles = (0, import_tailwind_merge29.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(Component, { ...props, ref, className: styles, children });
}
TimelineHeaderRoot.displayName = "MaterialTailwind.TimelineHeader";
var TimelineHeader = React29.forwardRef(TimelineHeaderRoot);
...
var TimelineIcon = React29.forwardRef(TimelineIconRoot);
...
var TimelineSeparator = React29.forwardRef(TimelineSeparatorRoot);
...
var TimelineBody = React29.forwardRef(TimelineBodyRoot);
...
function NavbarRoot({ as, color, variant, className, children, ...props }, ref) {
  ...
  color ??= defaultProps?.color ?? "default";
  variant ??= defaultProps?.variant ?? "solid";
  const styles = (0, import_tailwind_merge30.twMerge)(
    theme2.baseStyle,
    theme2.variant[variant][color],
    className
  );
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(Component, { ...props, ref, className: styles, children });
}
NavbarRoot.displayName = "MaterialTailwind.Navbar";
var Navbar = React30.forwardRef(NavbarRoot);

// src/components/badge.tsx
var React31 = __toESM(require("react"), 1);
var import_tailwind_merge31 = require("tailwind-merge");
var import_jsx_runtime33 = require("react/jsx-runtime");
var BadgeContext = React31.createContext({
  color: "primary",
  overlap: "square",
  placement: "top-end"
});
function BadgeRootBase({ as, color, overlap, placement, className, children, ...props }, ref) {
  ...
  const styles = (0, import_tailwind_merge31.twMerge)(theme2.baseStyle, className);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(Component, { ...props, ref, className: styles, children: /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(BadgeContext.Provider, { value: contextValue, children }) });
}
BadgeRootBase.displayName = "MaterialTailwind.Badge";
var BadgeRoot = React31.forwardRef(BadgeRootBase);
function BadgeContentRoot({ as, className, children, ...props }, ref) {
  const Component = as ?? "div";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.badgeContent ?? badgeContentTheme;
  const styles = (0, import_tailwind_merge31.twMerge)(theme2.baseStyle, className);
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsx)(Component, { ...props, ref, className: styles, children });
}
BadgeContentRoot.displayName = "MaterialTailwind.BadgeContent";
var BadgeContent = React31.forwardRef(BadgeContentRoot);
function BadgeIndicatorRoot({ as, className, children, ...props }, ref) {
  const Component = as ?? "span";
  const contextTheme = useTheme();
  const { overlap, placement, color } = React31.useContext(BadgeContext);
  const theme2 = contextTheme?.badgeIndicator ?? badgeIndicatorTheme;
  const styles = (0, import_tailwind_merge31.twMerge)(
    theme2.baseStyle,
...
var BadgeIndicator = React31.forwardRef(BadgeIndicatorRoot);
...
var SliderContext = React32.createContext({
  min: 0,
  max: 100,
  step: 1
});
function SliderRootBase({
  ...
  size ??= defaultProps?.size ?? "md";
  color ??= defaultProps?.color ?? "primary";
  const [uncontrolledValue, setUncontrolledValue] = React32.useState([
    0
  ]);
  ...
  const styles = (0, import_tailwind_merge32.twMerge)(theme2.baseStyle, theme2["size"][size], className);
  const elementRef = (0, import_react19.useMergeRefs)([sliderRef, ref]);
  return /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(SliderContext.Provider, { value: contextValue, children: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(Component, { ref: elementRef, ...props, className: styles, children }) });
}
SliderRootBase.displayName = "MaterialTailwind.Slider";
var SliderRoot = React32.forwardRef(SliderRootBase);
function SliderRangeRoot({ as, className, children, ...props }, ref) {
  const Component = as || "div";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.sliderRange ?? sliderRangeTheme;
  const { sliderRef, value, onValueChange, min, max, step, color } = React32.useContext(SliderContext);
  const sliderInstance = (0, import_react_ranger.useRanger)({
  ...
  return sliderInstance.getSteps().map(({ left, width }, i) => /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
    Component,
    {
      ref,
      ...props,
      className: (0, import_tailwind_merge32.twMerge)(
        theme2.baseStyle,
...
var SliderRange = React32.forwardRef(SliderRangeRoot);
function SliderThumbRoot({ as, className, children, ...props }, ref) {
  const Component = as || "button";
  const contextTheme = useTheme();
  const theme2 = contextTheme?.sliderThumb ?? sliderThumbTheme;
  const { sliderRef, value, onValueChange, min, max, step, size, color } = React32.useContext(SliderContext);
  const sliderInstance = (0, import_react_ranger.useRanger)({
    getRangerElement: () => sliderRef.current,
    values: value,
    min: min ?? 0,
  ...
  const styles = (0, import_tailwind_merge32.twMerge)(
    theme2.baseStyle,
    theme2["size"][size ?? "md"],
    theme2["color"][color ?? "primary"],
    className
...
var SliderThumb = React32.forwardRef(SliderThumbRoot);
function SliderTickRoot({ as, className, children, ...props }, ref) {
  ...
  return sliderInstance.getTicks().map(({ value: value2, key, percentage }) => /* @__PURE__ */ (0, import_react20.createElement)(
    Component,
    {
      ...props,
      key,
...
var SliderTick = React32.forwardRef(SliderTickRoot);
